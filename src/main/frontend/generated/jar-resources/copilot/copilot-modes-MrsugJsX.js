...
import { l as i, n as a, s as o } from "./consts-DOP4bWMB.js";
...
function f() {
	h().publicPluginsState === "NOT_INITIALIZED" && (g.push(import("./copilot-log-plugin-xBc31Mqq.js")), g.push(import("./copilot-info-plugin-Bxwkx4cR.js")), g.push(import("./copilot-features-plugin-CGKS5eeO.js")), g.push(import("./copilot-feedback-plugin-CteeRmCK.js")), g.push(import("./copilot-settings-panel-a-1nSj-q.js")), g.push(import("./copilot-impersonator-plugin-_M0PNaDW.js")), g.push(import("./copilot-development-setup-user-guide-DvHQnt6q.js")), g.push(import("./copilot-vaadin-versions-DDMx7O6Q.js")), v = !0, h().setPublicPluginsState("IMPORTED"));
}
function p() {
...
async function S() {
	return (await import("./copilot-focus-trap-CLsmCEKM.js")).copilotFocusTrap;
}
function C() {
